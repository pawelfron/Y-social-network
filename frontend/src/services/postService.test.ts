...
describe('PostService', () => {
  ...
  test('searchPosts returns filtered posts', async () => {
    const mockPosts: PostDetails[] = [
      { id: 1, content: 'Hello world', created_at: '', likes: [], likes_count: 0, author: { id: 1, username: 'test', profile_photo: null, followers_count: 10 }, image: '', is_own_post: false }
    ];
  ...
  test('getUserPosts filters posts by author id', async () => {
    const mockPosts: PostSummary[] = [
      { id: 1, content: 'Post 1', created_at: '', author: { id: 42, username: 'user1', profile_photo: null, followers_count: 10 }, image: '' },
      { id: 2, content: 'Post 2', created_at: '', author: { id: 99, username: 'user2', profile_photo: null, followers_count: 5 }, image: '' }
    ];
  ...
  test('createPost returns new post info', async () => {
    ...
    const mockResponse: PostInfo = { id: 123, content: 'New post', image: '', created_at: '', author: { id: 1, username: 'tester', profile_photo: null, followers_count: 0 } };
  ...
  test('updatePost returns updated post', async () => {
    ...
    const mockResponse: PostInfo = { id: postId, content: 'Updated post', image: '', created_at: '', author: { id: 1, username: 'tester', profile_photo: null, followers_count: 0 } };
