...
describe('UserService', () => {
  ...
  test('followUser returns follow data', async () => {
    const mockFollow: FollowManageData = { following: true, followers_count: 11 };
  ...
  test('unfollowUser returns unfollow data', async () => {
    const mockUnfollow: FollowManageData = { following: false, followers_count: 9 };
  ...
  test('getFollowers returns list of followers', async () => {
    const followers: userWithDate[] = [
      { id: 1, username: 'follower1', profile_photo: null, date_followed: '2024-01-01T00:00:00Z' }
    ];
  ...
  test('getFollowing returns list of following', async () => {
    const following: userWithDate[] = [
      { id: 2, username: 'followedUser', profile_photo: null, date_followed: '2024-01-02T00:00:00Z' }
    ];
